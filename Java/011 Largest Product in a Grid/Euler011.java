/*
 * In a 20 x 20 grid, find the greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally).
 */
...
public static void main(String[] args) {
    ...
    //4 across
    for (int[] row : grid) {
        for (int col = 0; col <= row.length-4; col++) {
            int product = row[col] * row[col+1] * row[col+2] * row[col+3];
